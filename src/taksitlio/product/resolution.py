    ...
    return [
        {
            ...
            "description": "Recovery-P1 dynamic apparel taxonomy seed",
        },
        {
            "category_code": "BAGS",
            "display_name": "Çanta",
            "synonyms": ["çanta", "çantası", "cüzdan", "valiz", "sırt çantası", "omuz çantası"],
            "description": "Recovery-P1 dynamic bags taxonomy seed",
        },
        {
            "category_code": "WATCHES",
            "display_name": "Saat",
            "synonyms": ["saat", "kol saati", "wristwatch"],
            "description": "Recovery-P1 dynamic watches taxonomy seed",
        },
        {
            "category_code": "FOOTWEAR_EXTRA",
            "display_name": None,  # merge into FOOTWEAR synonyms instead
            "synonyms": ["çizme", "sabo", "loafer", "sneaker", "spor ayakkabı", "topuklu", "babet", "sandalet"],
