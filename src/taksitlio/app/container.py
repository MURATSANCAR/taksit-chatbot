...
def build_demo_campaigns() -> list[Campaign]:
    ...
    return [
        ...
        Campaign(
            id=9502,
            campaign_code="alb-9502",
            title="Albaraka Türk ile Taksitlio.com'da Avantajlı Alışveriş!",
            summary="Albaraka Türk %1,99 Kar Oranı — 1.000–150.000 TL, 6 ay",
            category_code="MOBILE_PHONE",
            category_id=1,
            brand="Albaraka Türk",
            list_price=40000.0,
        ...
        Campaign(
            id=7802,
            campaign_code="kuv-7802",
            title="Kuveyt Türk Kampanyası!",
            summary="Kuveyt Türk %2,99 — yeni müşteri, 6 aya kadar",
            category_code="MOBILE_PHONE",
            category_id=1,
            brand="Kuveyt Türk",
            list_price=40000.0,
