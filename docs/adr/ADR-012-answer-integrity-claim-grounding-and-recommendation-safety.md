...
Kod iskeleti bu ADR kabul edildikten sonra P0 olarak ayrı sprintte başlar.
Bu belge yalnız bağlayıcı tasarımı sabitler.
...
- Kod P0’ı bu belgenin kabulünden sonra başlar.
